...
import { Plus, X, Upload, User, Filter, Grid, List, LogOut, Power, LayoutDashboard, ChevronLeft, ChevronRight, Server } from 'lucide-react';
import { collection, onSnapshot, doc, writeBatch, updateDoc, addDoc, deleteDoc } from "firebase/firestore";
import { db } from '../firebaseConfig';
import { AppLogo, CustomSelect } from './SharedUI';
