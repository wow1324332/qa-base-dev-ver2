...
export const ProjectsDashboard = ({ user, onNavigate, onLogout, onQuit }) => {
  ...
  return (
    <div className="w-screen h-screen bg-[#f8f9fa] flex flex-col overflow-hidden animate-simple-fade">
      <header className="h-20 px-8 flex justify-between items-center bg-[url('/header-bg.jpg')] bg-cover bg-[length:100%_100%] shadow-[0_8px_24px_-4px_rgba(0,0,0,0.5)]">
...
<div className="flex flex-1 overflow-hidden relative bg-[#f0f2f5]">
        ...
        <div 
          className="absolute inset-0 bg-cover bg-center bg-no-repeat blur-[1px] scale-[1.02] z-0 pointer-events-none"
