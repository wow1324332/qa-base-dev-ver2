...
export const ScheduleDashboard = ({ user, onNavigate, onLogout, onQuit }) => {
  ...
  return (
    <div className="w-screen h-screen bg-[#f8f9fa] flex flex-col overflow-hidden animate-simple-fade">
      ...
      >
        <aside className={`bg-white/60 backdrop-blur-xl border-r border-gray-100/50 rounded-r-2xl shadow-[-5px_0_30px_rgba(0,0,0,0.02)] transition-all duration-300 ease-in-out flex flex-col justify-between z-10 overflow-hidden whitespace-nowrap ${sidebarOpen ? 'w-64 translate-x-0' : 'w-0 -translate-x-full'}`}>
